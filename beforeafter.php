    ...
    <div class="sliders">
        ...
        <svg class="slider__mask" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
            ...
            <defs>
                ...
                <pattern id="pattern1l" patternUnits="userSpaceOnUse" width="562" height="366" viewBox="0 0 550 350">
                    <image href="image/Fliserens-før.jpg" width="562" height="366" />
                </pattern>

                <pattern id="pattern1r" patternUnits="userSpaceOnUse" x="315px" width="575" height="366" viewBox="0 0 550 350">
                    <image href="image/Fliserens-efter.jpg" width="575" height="366" />
                </pattern>

                <!-- Slide 2 -->

                <pattern id="pattern2l" patternUnits="userSpaceOnUse" width="562" height="366" viewBox="0 0 562 366">
                    <image href="https://images.unsplash.com/photo-1497377825569-02ad2f9edb81?dpr=1&auto=format&fit=crop&w=600&h=600&q=80&cs=tinysrgb&crop=&bg="
                           width="600px" height="600px"/>
                </pattern>

                <pattern id="pattern2r" patternUnits="userSpaceOnUse" x="365" width="562" height="366"
                         viewBox="0 0 562 366">
                    <image href="https://images.unsplash.com/photo-1496060169243-453fde45943b?dpr=1&auto=format&fit=crop&w=600&h=600&q=80&cs=tinysrgb&crop=&bg="
                           width="600px" height="600px"/>
                </pattern>

                <!-- Slide 3 -->

                <pattern id="pattern3l" patternUnits="userSpaceOnUse" width="562" height="366" viewBox="0 0 562 366">
                    <image href="https://images.unsplash.com/photo-1497377825569-02ad2f9edb81?dpr=1&auto=format&fit=crop&w=600&h=600&q=80&cs=tinysrgb&crop=&bg="
                           width="600px" height="600px"/>
                </pattern>

                <pattern id="pattern3r" patternUnits="userSpaceOnUse" x="365" width="562" height="366"
                         viewBox="0 0 562 366">
                    <image href="https://images.unsplash.com/photo-1496060169243-453fde45943b?dpr=1&auto=format&fit=crop&w=600&h=600&q=80&cs=tinysrgb&crop=&bg="
                           width="600px" height="600px"/>
                </pattern>
                ...
                <pattern id="pattern4l" patternUnits="userSpaceOnUse" width="562" height="366" viewBox="0 0 562 366">
                    <image href="https://images.unsplash.com/photo-1497377825569-02ad2f9edb81?dpr=1&auto=format&fit=crop&w=600&h=600&q=80&cs=tinysrgb&crop=&bg="
                           width="600px" height="600px"/>
                </pattern>

                <pattern id="pattern4r" patternUnits="userSpaceOnUse" x="365" width="562" height="366"
                         viewBox="0 0 562 366">
                    <image href="https://images.unsplash.com/photo-1496060169243-453fde45943b?dpr=1&auto=format&fit=crop&w=600&h=600&q=80&cs=tinysrgb&crop=&bg="
                           width="600px" height="600px"/>
                </pattern>
        ...
        <div class="slide" id="slide-1">
            ...
            <div class="slide__images">
                <div class="slide__image slide__image--left">
                    <svg viewBox="0 0 900 365" xmlns="http://www.w3.org/2000/svg"
